...
def objective(trial):
    ...
    for horizon_idx, pred_len in enumerate(HORIZON_LENGTHS):
        ...
        cmd_args.extend(['--model_id', f'ETTm2_96_{pred_len}'])
...
def save_study_results(study, output_file='hpo_results_ettm2_optuna.json'):
...
if __name__ == '__main__':
    ...
    print(f"{'='*80}")
    print(f"Starting Optuna HPO for ByteHnet on ETTm2")
    print(f"{'='*80}")
    ...
    output_path = os.path.join(hpo_dir, 'hpo_results_ettm2_optuna.json')
