...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, time_attention, variate_attention, cross_attention, d_model, d_ff=None,
        ...
        self.variate_attention = variate_attention  # Self-attention for variate_wise_features
    ...
    def forward(self, variate_wise_features, time_wise_features, c_in, d_model, x_mask=None, cross_mask=None, tau=None, delta=None, chunking_mask=None):
        ...
        y = variate_wise_features = self.norm3(variate_wise_features)
...
class Decoder(nn.Module):
    ...
    def forward(self, x, cross, x_mask=None, cross_mask=None, tau=None, delta=None, chunking_mask=None):
        for layer in self.layers:
            ...
            x, cross = layer(x, cross, self.c_in, self.d_model, x_mask=x_mask, cross_mask=cross_mask, tau=tau, delta=delta, chunking_mask=chunking_mask)
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.global_embedding = nn.Linear(self.seq_len, self.d_model)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        x_global = self.global_embedding(x_enc.permute(0, 2, 1)) # [B, c, d_model]
